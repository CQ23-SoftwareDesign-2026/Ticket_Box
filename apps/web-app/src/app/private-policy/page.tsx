...
import { Shield, Lock, Eye, UserCheck, Clock, Mail, Info, Calendar } from "lucide-react";
...
const sections = [
  {
    ...
    description: "Các loại dữ liệu cá nhân chúng tôi thu thập khi bạn sử dụng dịch vụ.",
    content:
  ...
  },
  {
    ...
    description: "Cách thức chúng tôi xử lý dữ liệu để phục vụ trải nghiệm đặt vé của bạn.",
    content:
  ...
  },
  {
    ...
    description: "Chính sách cam kết bảo vệ thông tin cá nhân của bạn an toàn tuyệt đối.",
    content:
  ...
  },
  {
    ...
    description: "Thời gian lưu trữ dữ liệu cá nhân trên hệ thống của chúng tôi.",
    content:
        ...
        <div className="relative overflow-hidden py-20 border-b border-slate-800">
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center sm:text-left">
            ...
            <p className="mt-4 text-base sm:text-lg text-on-surface-variant/80 max-w-2xl leading-relaxed">
              TicketBox cam kết bảo mật tuyệt đối mọi thông tin cá nhân và dữ liệu giao dịch của bạn. Dưới đây là chính sách minh bạch của chúng tôi về thu thập, sử dụng và bảo vệ dữ liệu.
            </p>
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row gap-5 items-start">
                      <div className={`p-3.5 rounded-2xl ${sec.bgColor} shrink-0`}>
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-base text-on-surface-variant/90 leading-relaxed">
                        Nếu bạn có bất kỳ câu hỏi nào liên quan đến Chính sách bảo mật hoặc muốn thực hiện quyền hạn bảo vệ dữ liệu cá nhân của mình, vui lòng kết nối với đội ngũ phát triển TicketBox qua các hòm thư điện tử dưới đây:
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-xs text-on-surface-variant/60 sm:pl-14 pt-2">
                    ...
                    <span>Chúng tôi thường phản hồi các yêu cầu bảo mật trong vòng 24 - 48 giờ làm việc.</span>
                  </div>
                </div>
              </section>
