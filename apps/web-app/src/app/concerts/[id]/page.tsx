          ...
          <div className="space-y-8">
            <Card className="overflow-hidden border-0 shadow-md bg-white p-6 sm:p-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="font-display text-2xl font-bold text-gray-900">Select Section</h2>
              </div>

              <div className="bg-gray-50 rounded-2xl border border-gray-100 p-8 flex flex-col items-center justify-center min-h-[300px]">
                {concert.mapUrl && concert.mapUrl !== "https://cdn.ticketbox.local/maps/default.svg" ? (
                  <img src={concert.mapUrl} alt="Seat Map" className="w-full h-auto max-h-[350px] object-contain" />
                ) : (
                  <img src="/mock/seat_map.svg" alt="Seat Map" className="w-full h-auto max-h-[350px] object-contain" />
                )}
                <div className="mt-8 text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto mb-2 text-gray-400" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h6v6" /><path d="M9 21H3v-6" /><path d="M21 3l-7 7" /><path d="M3 21l7-7" /></svg>
                  <p className="text-sm font-semibold text-gray-700">Interactive Map Canvas</p>
                </div>
              </div>
            </Card>
